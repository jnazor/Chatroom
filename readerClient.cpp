/*
 * Reader Client program being used by Jolie Nazor and Kristi Yost for the CS 450 Chatroom 
...
int main(int argc, char * argv[]) {
	...
	while(true){
	    len = readn(s, (char *) &buflen, sizeof(short));
	    buflen = ntohs(buflen);
	    //cout << "buflen: " << buflen << endl;
	    n = readn(s, buf, buflen);
            buf[buflen] = '\0';
